...
foreach ($f in $files) {
  ...
  $c = [regex]::Replace($c, '£130/hr', '£160/hr', 'IgnoreCase')
  $c = [regex]::Replace($c, '£110/hour \+\s*VAT \(8am-6pm weekdays\)', '£120/hour + VAT (8am-6pm weekdays)', 'IgnoreCase')
  $c = [regex]::Replace($c, '£130/hour \+\s*VAT', '£160/hour + VAT', 'IgnoreCase')
  ...
  $c = [regex]::Replace($c, 'Drainage: From £120/hr \+ VAT \(weekdays\) \| £140/hr \+VAT \(evenings/weekends\)', 'Drainage &amp; Emergency Drainage: £120/hr +VAT (Mon-Fri 8am-6pm) | £160/hr +VAT (Mon-Fri 6pm-8am) | £160/hr +VAT (Weekends)', 'IgnoreCase')

  # Service-page regional split bullets -> unified all-areas line
  $c = [regex]::Replace($c, '<li>London: From £120/hr \+VAT \(weekdays\) \| £140/hr \+VAT \(evenings/weekends\)</li>', '<li>All areas: From £120/hr +VAT (weekdays) | £160/hr +VAT (evenings/weekends)</li>', 'IgnoreCase')
  ...
  $c = [regex]::Replace($c, 'All areas: From £120/hr \+VAT \(weekdays\) \| £140/hr \+VAT \(evenings/weekends\)', 'All areas: £120/hr +VAT (Mon-Fri 8am-6pm) | £160/hr +VAT (Mon-Fri 6pm-8am) | £160/hr +VAT (Weekends)', 'IgnoreCase')
  ...
  $c = [regex]::Replace($c, 'Reading\s*&amp;\s*Slough:\s*From £120/hr \+ VAT \(weekdays\) \| £140/hr \+VAT \(evenings/weekends\)', 'All areas: £120/hr +VAT (Mon-Fri 8am-6pm) | £160/hr +VAT (Mon-Fri 6pm-8am) | £160/hr +VAT (Weekends)', 'IgnoreCase')
